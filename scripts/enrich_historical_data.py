...
MARKETDATA_API_KEY = os.environ.get("MARKETDATA_API_KEY", "ZElKSW5jdjBNb1doNkppaktGZUFEeTdFNVVxdDZoWXZfSXZWTHBrOHFTbz0")
TRADIER_API_KEY = os.environ.get("TRADIER_API_KEY", "AKWggKcLnkrnIGdVbAOXZ9JE36Xp")
