...
ILLIQUID_OPTIONS_BLACKLIST = {
    ...
    "NWS", "FOX", "REG", "STE", "KRYS", "IEX", "NWSA", "AIZ",
    "SLAB", "WAT", "VLTO", "CRNX", "NDSN", "L", "RVTY", "ALLE",
    "ERIE", "PKG", "FTV", "AVY", "FORM", "PFG", "HSIC", "WAB",
    "GFS", "LNT", "WTW", "CHPT", "GL", "HUBB", "ROP", "TECH",
    "MTD", "CPAY", "EPAM",

    # === NIEDRIG (50-99 Bars) - Sehr dünn gehandelt ===
    "PNW", "HST", "AEE", "EXAS", "CMS", "SW", "UDR", "ATO",
    "PODD", "Q", "AMCR", "AOS", "WOLF", "TRMB", "CRL", "SNA",
    "ROL", "CPT", "DTE", "EXPD", "RDW", "VRSK", "FRT", "JKHY",
    "BG", "MAS", "TDY", "PTC", "VTRS", "DOCN", "GLBE", "ESS",
    "EVRG", "FOXA", "EG", "J", "SOLV", "VTR", "CRUS", "LII",
    "WST", "MLM", "KIM", "BRO", "NI", "NTRS", "CINF", "IR", "BR",

    # === MITTEL-NIEDRIG (100-199 Bars) - Eingeschränkt nutzbar ===
    "CDW", "TYL", "PNR", "AME", "NTRA", "ES", "LH", "TRGP",
    "IQV", "TME", "ZBRA", "DOC", "CBRE", "COO", "CHRW", "HII",
    "KEYS", "AMP", "HOLX", "CTVA", "WRB", "DAY", "GDDY", "AKAM",
    "UHS", "CHD", "EA", "DOV", "TXT", "HAS", "RJF", "ODFL",
    "SBAC", "DD", "BXP", "RMBS", "XYL", "VMC", "GLW", "GEN",
    "TSN", "CSGP", "ACGL", "VRSN", "CFLT", "TPL", "IVZ", "HIG",
    "EFX", "LHX", "MTB", "WEC", "ZBH", "ECL", "EXR", "VICI",
    "INCY", "BEN", "PAYC", "TKO", "CFG", "LCID", "ALB", "TER",
    "MPWR", "EQR", "INVH",

    # === MITTEL (200-299 Bars) - Eingeschränkt nutzbar ===
    "FIX", "MNDY", "BALL", "FISV", "ETR", "TDG", "AVB", "MOS",
    "LUNR", "GWW", "IDXX", "PPL", "CNP", "APH", "BKR", "LW",
    "STT", "ESTC", "GRMN", "OMC", "JBHT", "NTAP", "RSG", "MAA",
    "RMD", "DLO", "SRE", "DVA", "HUBS", "KEY", "RL", "CBOE",
    "EME", "SLB", "BEKE", "VEEV", "GPC", "CAH", "PENN", "XEL",
    "BK", "LRCX", "PH", "JBL", "KTOS", "TSCO", "CTRA", "PEG",
    "ROK", "WMB", "MCO", "LI", "AON", "FIS", "IT", "XLRE",
    "MKC", "WSM", "AES", "FFIV", "ADM", "NIO", "WDC", "COR",
    "DGX", "TEL", "A", "ED", "TAP", "TRV", "IFF", "SWKS",
    "PCAR", "NSC", "MTCH", "WY", "POOL", "EIX", "MSCI",
}
