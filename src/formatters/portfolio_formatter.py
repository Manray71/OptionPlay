...
class PortfolioFormatter:
    ...
    def format_summary(self, summary: PortfolioSummary) -> str:
        ...
        if summary.positions_expiring_soon > 0:
            b.kv_line(
                "Expiring Soon", f"⚠️ {summary.positions_expiring_soon} positions (within 7 days)"
            )
        else:
    ...
    def format_positions_table(
        self, positions: List[BullPutSpread], title: str = "Positions"
    ) -> str:
        ...
        b.table(["ID", "St", "Symbol", "Strikes", "Exp", "DTE", "Credit", "P&L"], rows)
