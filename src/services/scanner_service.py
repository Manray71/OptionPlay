...
from ..vix_strategy import get_strategy_for_vix, StrategyRecommendation
...
class ScannerService(BaseService):
    ...
    async def scan(
        ...
        # Determine min_score
        effective_min_score = self._determine_min_score(
            strategy, min_score, recommendation
        )
    ...
    async def scan_multi(
        ...
        historical_days = max(
            ...
            260 if enable_breakout else 90
        )
