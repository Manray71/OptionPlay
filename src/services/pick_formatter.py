...
Single Source of Truth für alle Pick-Formatierung:
  - format_picks_markdown()       — einfaches Markdown (recommendation_engine)
  - format_single_pick()          — einzelner Pick, einfaches Format
  - format_picks_v2()             — MarkdownBuilder v2 (MCP daily picks)
  - format_single_pick_v2()       — einzelner Pick, v2 mit Chain-Daten
"""
...
def format_single_pick_v2(b: MarkdownBuilder, pick) -> None:
    """
