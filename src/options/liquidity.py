...
class LiquidityAssessor:
    ...
    def _determine_quality(
        self, oi: int, spread_pct: float, volume: int
    ) -> str:
    ...
    def _find_option(
        self, strike: float, options_data: List[Dict]
    ) -> Optional[Dict]:
    ...
    def _build_warnings(
        self, short_liq: LiquidityInfo, long_liq: LiquidityInfo
    ) -> List[str]:
