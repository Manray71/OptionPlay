...
class TestVIXValidation:
    ...
    def test_vix_negative_returns_unknown(self):
        ...
        regime = selector.get_regime(-5.0)
    ...
    def test_vix_negative_minus_one(self):
        ...
        regime = selector.get_regime(-1.0)
    ...
    def test_vix_negative_small(self):
        ...
        regime = selector.get_regime(-0.01)
    ...
    def test_vix_zero_is_low_vol(self):
        ...
        regime = selector.get_regime(0.0)
    ...
    def test_vix_extreme_high_returns_high_vol(self):
        ...
        regime = selector.get_regime(150.0)
    ...
    def test_vix_exactly_100(self):
        ...
        regime = selector.get_regime(100.0)
    ...
    def test_vix_101_with_warning(self):
        ...
        regime = selector.get_regime(101.0)
    ...
    def test_vix_none_returns_unknown(self):
        ...
        regime = selector.get_regime(None)
        
        assert regime == MarketRegime.UNKNOWN


class TestVIXNormalRanges:
    """Tests für normale VIX-Bereiche"""
    ...
    def test_vix_low_vol_range(self):
        ...
        for vix in [0.0, 5.0, 10.0, 14.0, 14.99]:
            assert selector.get_regime(vix) == MarketRegime.LOW_VOL
    ...
    def test_vix_normal_range(self):
        ...
        for vix in [15.0, 16.0, 17.5, 19.0, 19.99]:
            assert selector.get_regime(vix) == MarketRegime.NORMAL
    
    def test_vix_elevated_range(self):
        """Test: VIX 20-29.99 ist ELEVATED"""
        selector = VIXStrategySelector()
        
        for vix in [20.0, 22.5, 25.0, 28.0, 29.99]:
            assert selector.get_regime(vix) == MarketRegime.ELEVATED
    ...
    def test_vix_high_vol_range(self):
        ...
        for vix in [30.0, 35.0, 50.0, 80.0, 100.0]:
            assert selector.get_regime(vix) == MarketRegime.HIGH_VOL
...
class TestRecommendationWithValidation:
    ...
    def test_recommendation_for_none_vix(self):
        ...
        assert rec.regime == MarketRegime.UNKNOWN
        assert "VIX nicht verfügbar" in rec.warnings[0] or "nicht verfügbar" in rec.reasoning
...
class TestBoundaryConditions:
    ...
    def test_exact_boundaries(self):
        """Test: Exakte Grenzen werden korrekt zugeordnet"""
        selector = VIXStrategySelector()
        
        # Bei exakt 15.0 -> NORMAL (nicht mehr LOW_VOL)
        assert selector.get_regime(14.99) == MarketRegime.LOW_VOL
        assert selector.get_regime(15.0) == MarketRegime.NORMAL
        
        # Bei exakt 20.0 -> ELEVATED
        assert selector.get_regime(19.99) == MarketRegime.NORMAL
        assert selector.get_regime(20.0) == MarketRegime.ELEVATED
        
        # Bei exakt 30.0 -> HIGH_VOL
        assert selector.get_regime(29.99) == MarketRegime.ELEVATED
        assert selector.get_regime(30.0) == MarketRegime.HIGH_VOL
    ...
    def test_float_precision(self):
        ...
        assert selector.get_regime(14.999999999) == MarketRegime.LOW_VOL
        assert selector.get_regime(15.000000001) == MarketRegime.NORMAL
